using MarsProjectAdvance2.Extension;
...
namespace MarsProjectAdvance2.Pages
{
    class Profile
    {
        ...
        //Find Profile tab
        [FindsBy(How = How.XPath, Using = "//section//div//a[@href='/Account/Profile']")]
        ...
        //Find Language tab
        [FindsBy(How = How.XPath, Using = "//div//a[@data-tab ='first' and contains(text(), 'Languages')]")]
        ...
        //Find Skills tab
        [FindsBy(How = How.XPath, Using = "//div//a[@data-tab='second' and contains(text(), 'Skills')]")]
        ...
        //Find Education tab
        [FindsBy(How = How.XPath, Using = "//div//a[@data-tab='third' and contains(text(), 'Education')]")]
        ...
        [FindsBy(How = How.XPath, Using = "//div//a[@data-tab='fourth' and contains(text(), 'Certification')]")]
        ...
        //Mousehover on user name and click on Change Password on the profile page
        ...
        {
            driver.WaitForElementIsVisible(AddNewCertification);
            //Click on AddNew button
            AddNewCertification.Click();

            //Enter Certificate name 
            driver.WaitForElementIsVisible(CertificateTextBox);
